...
const CampaignDetailModal = ({ campaign, onClose }) => {
  ...
  const StorySection = () => (
    <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
      ...
      <p>Our team has been working tirelessly to ensure that every dollar raised goes directly toward the cause. We believe in complete transparency and will provide regular updates on how funds are being used.</p>
    </div>
  );
